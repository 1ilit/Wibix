    ...
    <>
      ...
      <div className="ask-header mb-3">
        ...
        <h2 className="text-white position-absolute bottom-0 start-0 ms-5 mb-4 ps-md-5 fw-bold">
          <span className="ms-md-4">Terms and Conditions</span>
        </h2>
      </div>
        ...
        <div className="row">
          <div className="col-md-3">
            <div className="bg-light border border-muted p-3 mb-4">
              ...
              <p className="px-3 py-2 bg-white li-accent">
                <a href="#2" className="wibix-link no-decor fw-bold">
                  Cookies
                </a>
              </p>
              <p className="px-3 py-2 bg-white li-accent">
              ...
              <p className="px-3 py-2 bg-white li-accent">
                <a href="#7" className="wibix-link no-decor fw-bold">
                  Your privacy
                </a>
              </p>
              <p className="px-3 py-2 bg-white li-accent">
                <a href="#8" className="wibix-link no-decor fw-bold">
                  Reservation of rights
                </a>
              </p>
              <p className="px-3 py-2 bg-white li-accent">
                <a href="#9" className="wibix-link no-decor fw-bold">
                  Removal of links from our website
                </a>
              </p>
              <p className="px-3 py-2 bg-white li-accent">
                <a href="#10" className="wibix-link no-decor fw-bold">
                  Disclaimer
                </a>
              </p>
            </div>
          ...
          <div className="col-md-9">
            <div className="ms-md-5">
              ...
              <p>
                ...
                the use of wibix's Website, located at wibix.com.
              </p>

              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use wibix if you do not agree to
              ...
              <p>
                We employ the use of cookies. By accessing wibix, you agreed to
                use cookies in agreement with the wibix's Privacy Policy.{" "}
              </p>
              ...
              <p>
                Unless otherwise stated, wibix and/or its licensors own the
                intellectual property rights for all material on wibix. All
                intellectual property rights are reserved. You may access this
                from wibix for your own personal use subjected to restrictions
                set in these terms and conditions.
              </p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from wibix</li>
                <li>Sell, rent or sub-license material from wibix</li>
                <li>Reproduce, duplicate or copy material from wibix</li>
                <li>Redistribute content from wibix</li>
              </ul>
              ...
              <p>
                ...
                website. wibix does not filter, edit, publish or review Comments
                prior to their presence on the website. Comments do not reflect
                the views and opinions of wibix,its agents and/or affiliates.
                ...
                laws, wibix shall not be liable for the Comments or for any
              ...
              <p>
                wibix reserves the right to monitor all Comments and to remove
              ...
              <p>
                You hereby grant wibix a non-exclusive license to use,
              ...
              <p>
                ...
                of wibix; and (d) the link is in the context of general resource
                information.
              </p>
              ...
              <p>
                ...
                by sending an e-mail to wibix. Please include your name, your
              ...
              <p>
                No use of wibix's logo or other artwork will be allowed for
